    ...
    public class Ship : GameItem
    {
        ...
        public static new void LoadContent(ContentManager content)
        {
            ...
            new Ship("Discovery", 1, content.Load<Texture2D>("Images/Ships/Discovery"),
                80, 25, 8, 0.05f, 0.025f, 0.0003f, new List<Type>() { typeof(LaserWeapon), typeof(MissileWeapon) }, 
                "A basic, slow trading ship.");
            new Ship("Neon Cruiser", 2, content.Load<Texture2D>("Images/Ships/NeonCruiser"),
                120, 35, 12, 0.1f, 0.03f, 0.0004f, new List<Type>() { typeof(LaserWeapon), typeof(LaserWeapon), typeof(BombWeapon) },
            ...
            new Ship("Viridian", 3, content.Load<Texture2D>("Images/Ships/Viridian"),
                130, 40, 6, 0.04f, 0.025f, 0.0002f, new List<Type>() { typeof(MissileWeapon), typeof(MissileWeapon), typeof(BombWeapon) },
                "A slower ship specializing in explosives.");
            new Ship("Eos", 2, content.Load<Texture2D>("Images/Ships/Eos"),
                80, 35, 10, 0.04f, 0.03f, 0.0003f, new List<Type>() { typeof(BombWeapon), typeof(BombWeapon), typeof(BombWeapon) },
            ...
            new Ship("Ocean Jet", 3, content.Load<Texture2D>("Images/Ships/OceanJet"),
                170, 50, 18, 0.12f, 0.04f, 0.0005f, new List<Type>() { typeof(LaserWeapon), typeof(LaserWeapon), typeof(MissileWeapon), typeof(BombWeapon) },
